...
class DevisCalculator {
    ...
    get_prix_tache_5(donnees_json) {
      ...
      murs.forEach((mur, index) => {
          ...
          prix += sousTotalGamme;
          formule += `<u>Pose du mur ${index + 1}</u>\n Surface : ${surface} m²\n Gamme : ${gammeTitre}\n`;
          ...
          formule += `<u>Dépose du mur ${index + 1}</u>\n Surface : ${surface} m²\n Revêtement à déposer ${titreDepose}\n`;
    ...
    get_prix_tache_2(donnees_json) {
      ...
      gammes_depose_form.forEach(element => {
        ...
        prix += prixLocal;
        if(qte){
          formule += `<u>Dépose de ${element.titre}</u>\n Quantité : ${qte}\n`;
      ...
      return {
       ...
       get_prix_tache_3(donnees_json) {
        ...
        if (has_partie_murs) {
          ...
          for (let i = 0; i < total_murs; i++) {
           ...
           let surface_mur = mursnonporteurs[i].longueur*mursnonporteurs[i].hauteur*mursnonporteurs[i].epaisseur/1000000;
            ...
            formule += `<u>Mur ${i+1}</u> - surface : ${surface_mur} m²\n`;
          }
        }
        ...
        if (has_partie_ouvertures) {
          ...
          for (let j = 0; j < total_ouvertures; j++) {
            ...
            formule += `<u>Ouverture ${j+1}</u> - surface :${surface_ouverture} m² \n`;
          }
        }
       ...
       get_prix_tache_9(donnees_json) {
        ...
        if (prix_depose>0) {
          ...
          prix += sousTotaldepose;
          formule += `<u>Dépose</u>\n  Surface : ${surface} m² \n Revêtement à déposer : ${nom_depose}\n`;
      }
        ...
        if (gammes.plinthes) {
            ...
            formule += `<u>Pose de plinthes</u>\n Surface : ${surface} m² \n Type de plinthes : ${nomPlinthes}\n`;
        }
        ...
        return {
         ...
         get_prix_tache_13(donnees_json) {
          ...
          let nom_gamme =  (gamme.split(":")[2]);;
              ...
              formule += `<u>Gamme sélectionnée</u> : ${nom_gamme}\n`;
        ...
        get_prix_tache_15(donnees_json) {
          ...
          if(chauffage_exist){
            ...
            formule += `<u>Rénovation de chauffage</u> : ${quantite_chauffage}\n`;
          }else{
            formule += `<u>Rénovation de chauffage</u> : Non\n`;
         ...
         get_prix_tache_16(donnees_json) {
          ...
          appareils_pose.forEach((appareil, index) => {
              if (appareil.active) {
                  ...
                  prix += prixModele;
                  formule += `<u>Pose de ${titreModele}</u> : 1 \n`;
          ...
          appareils_depose.forEach((appareil, index) => {
            if (appareil.quantite>0) {
                ...
                prix += prixModele;
                formule += `<u>Dépose de ${titreModele}</u> : 1 \n`;
            }
